...
(cl:defmethod cl:initialize-instance :after ((m <Joy>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asv_control-msg:<Joy> is deprecated: use asv_control-msg:Joy instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_control-msg:header-val is deprecated.  Use asv_control-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'axes-val :lambda-list '(m))
(cl:defmethod axes-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_control-msg:axes-val is deprecated.  Use asv_control-msg:axes instead.")
  (axes m))

(cl:ensure-generic-function 'buttons-val :lambda-list '(m))
(cl:defmethod buttons-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_control-msg:buttons-val is deprecated.  Use asv_control-msg:buttons instead.")
  (buttons m))
